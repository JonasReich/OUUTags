...
public:
	...
	{
		return OUUTags::Private::ForEachTypedTagRootTag_Recursive<InRootLiteralTagTypes...>(
	...
	static bool ForAllRootTags(const CallableT& Callable)
	{
		...
		if (OUUTags::Private::ForEachTypedTagRootTag_Recursive<InRootLiteralTagTypes...>(HandleRootTag))
		{
			return true;
		}
...
USTRUCT()
struct OUUTAGS_API FTypedGameplayTag_Base : public FGameplayTag
{
	GENERATED_BODY()
public:
