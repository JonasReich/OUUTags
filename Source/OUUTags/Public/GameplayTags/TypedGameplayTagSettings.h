...
class OUUTAGS_API UTypedGameplayTagSettings : public UDeveloperSettings
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY(
		EditAnywhere,
		meta = (ForceInlineRow, ReadOnlyKeys, DisplayName = "Gameplay Tag Types"),
		Category = "OUU|Typed Gameplay Tag|Settings")
