...
namespace OUUTags::Private::GameplayTagQueryParser
{
	/**
	...
	public:
		...
		FString ToString() const
		{
			...
			const FString TagsString = FString::JoinBy(Tags, TEXT(", "), [](const FGameplayTag& Element) {
...
{
	namespace QueryParser = OUUTags::Private::GameplayTagQueryParser;
