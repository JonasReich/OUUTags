...
namespace OUUTags::GameplayTagAudit
{
	...
	{
		UE_LOG(LogOUUTags, Log, TEXT("Gameplay Tag Audit START"));
		UE_LOG(LogOUUTags, Log, TEXT("----------"));
		UE_LOG(
			LogOUUTags,
			Log,
		...
		UE_LOG(LogOUUTags, Log, TEXT("----------"));
		UE_LOG(LogOUUTags, Log, TEXT("Gameplay tag stats:"));
		UE_LOG(LogOUUTags, Log, TEXT("Explicit tags:         %i"), NumExplicitTags);
		UE_LOG(LogOUUTags, Log, TEXT("Implicit tags:         %i"), NumImplicitTags);
		UE_LOG(LogOUUTags, Log, TEXT("Total tags:            %i"), NumExplicitTags + NumImplicitTags);
		UE_LOG(LogOUUTags, Log, TEXT("Total referencers:     %i"), NumReferencers);
		UE_LOG(LogOUUTags, Log, TEXT("Avg referencers:       %i"), AverageNumReferencers);
		UE_LOG(LogOUUTags, Log, TEXT("Med referencers:       %i"), MedianNumReferencers);
		UE_LOG(LogOUUTags, Log, TEXT("Min referencers:       %i"), MinNumReferencers);
		UE_LOG(LogOUUTags, Log, TEXT("Max referencers:       %i"), MaxNumReferencers);
		UE_LOG(LogOUUTags, Log, TEXT("Unused tags (no refs): %i"), NumUnreferencedTags);
		UE_LOG(LogOUUTags, Log, TEXT("----------"));
		UE_LOG(LogOUUTags, Log, TEXT("Gameplay Tag Audit END"));
	}
