...
#include "GameplayTagsTestMacros.h"
...
void FTagDependenciesSpec::Define()
{
	...
	Describe("OnTagsChanged", [this]() {
		BeforeEach([this]() {
			...
			FGameplayTagDependencyEvent Event;
			Event.BindDynamic(EventHandler, &UGameplayTagDependency_TestEventHandler::HandleOnTagsChanged);
